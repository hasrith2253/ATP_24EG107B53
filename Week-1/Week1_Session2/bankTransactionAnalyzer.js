...
// Hasrith's bank transactions
const transactions = [
  { id: 1, type: "credit", amount: 15000 }, // Salary
  { id: 2, type: "debit", amount: 3500 },   // Laptop purchase
  { id: 3, type: "credit", amount: 8000 },  // Freelance project
  { id: 4, type: "debit", amount: 1200 }    // Monthly rent
];

// 1) filter() all credit transactions - Hasrith's income
let type_of_transac=transactions.filter(ele=>ele.type=="credit")
console.log("Hasrith's Credit Transactions:", type_of_transac)

...
commanApp.post("/users", upload.single('profileImageUrl'), async (req,res)=>{

    try {
        // define allowed roles for registration
        let allowedRoles = ["USER","AUTHOR"]

        // get user data from request body (parsed by multer)
        const newUser = req.body

        // If file exists, add its path to newUser object
        if (req.file) {
...
// check-auth router
commanApp.get("/check-auth", async (req, res) => {

...
let createlevel=createGame('hasrith rao')  // createlevel is the var that store the return value of createGame function and createGame function return another function as parameter as level of the same name
createlevel(1);
createlevel(2);
createlevel(9);

let level=createGame('Ravi')  // createlevel is the var that store the return value of createGame function and createGame function return another function as parameter as level of the same name
level(5);
level(6);
...
/* Array of Objects */
let emps=[{eno:1,name:'rohith'},{ eno:2,name:'max'}];
